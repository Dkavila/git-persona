...
func testProfile() config.Profile {
	return config.Profile{
		Name:    "work",
		Email:   "derick@corp.com",
		KeyPath: "/home/derick/.ssh/id_ed25519_work",
	}
}
...
func TestApplyProfile_SetsThreeGlobalKeys(t *testing.T) {
	...
	want := [][]string{
		...
		{"config", "--global", "user.email", "derick@corp.com"},
		{"config", "--global", "core.sshCommand", `ssh -i "/home/derick/.ssh/id_ed25519_work" -o IdentitiesOnly=yes`},
	}
...
func TestSSHCommand_Format(t *testing.T) {
	got := git.SSHCommand("/home/derick/.ssh/id_ed25519_work")
	want := `ssh -i "/home/derick/.ssh/id_ed25519_work" -o IdentitiesOnly=yes`
...
func TestSSHCommand_NormalisesWindowsPath(t *testing.T) {
	got := git.SSHCommand(`C:\Users\Derick\.ssh\id_ed25519_work`)
	want := `ssh -i "C:/Users/Derick/.ssh/id_ed25519_work" -o IdentitiesOnly=yes`
...
func TestSSHCommand_QuotesPathWithSpaces(t *testing.T) {
	got := git.SSHCommand(`C:\Users\Derick Avila\.ssh\id_ed25519_work`)
	want := `ssh -i "C:/Users/Derick Avila/.ssh/id_ed25519_work" -o IdentitiesOnly=yes`
...
func TestCurrentGlobalIdentity(t *testing.T) {
	...
	if email != "derick@corp.com" {
		t.Fatalf("email = %q, want %q", email, "derick@corp.com")
	}
